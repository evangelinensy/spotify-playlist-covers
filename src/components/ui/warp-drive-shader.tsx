...
const WarpDriveShader = () => {
  ...
  useEffect(() => {
    ...
    if (!container) {
      console.log('❌ WarpDriveShader: Container not found');
      return;
    }
    
    console.log('✅ WarpDriveShader: Initializing...');
    ...
    console.log('✅ WarpDriveShader: Renderer created and appended to container');
    ...
    console.log('✅ WarpDriveShader: Animation loop started');
